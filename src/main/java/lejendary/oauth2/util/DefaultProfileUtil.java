...
public final class DefaultProfileUtil {
    ...
    private final static Logger log = LoggerFactory.getLogger(DefaultProfileUtil.class);
    private final static String SPRING_PROFILE_ACTIVE = "spring.profiles.active";
    private final static Properties BUILD_PROPERTIES = readProperties();
    ...
    public static String getDefaultActiveProfiles() {
        if (BUILD_PROPERTIES != null) {
            ...
            if (activeProfile != null && !activeProfile.isEmpty() &&
                    (activeProfile.contains(AppConstants.SPRING_PROFILE_DEVELOPMENT) ||
                            activeProfile.contains(AppConstants.SPRING_PROFILE_PRODUCTION))) {
                return activeProfile;
            }
        }
        log.warn("No Spring profile configured, running with default profile: {}", AppConstants.SPRING_PROFILE_DEVELOPMENT);
        return AppConstants.SPRING_PROFILE_DEVELOPMENT;
    }
